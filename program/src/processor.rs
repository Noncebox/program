...
impl Processor {
    ...
    pub fn process_create_ntoken(
        ...
        crate::ntoken::NToken::pack(&ntoken,ntoken.data.borrow_data());
        Ok(())
    }
    ...
    pub fn process_supply(
        ...
        let swap_token_a_amount = to_u128(swap_token_a.amount)?;
        let swap_token_b_amount = to_u128(swap_token_b.amount)?;
        let obj = crate::lend::Assets::new();
        obj.supply(amount);
        crate::crate::lend::Assets::pack(&obj,ntoken.data.borrow_data());
        Ok(())
    }
    ...
    pub fn process_stake(
        ...
        let swap_token_a_amount = to_u128(swap_token_a.amount)?;
        let swap_token_b_amount = to_u128(swap_token_b.amount)?;
        let obj = crate::stake::Farm::new();
        obj.stake(amount);
        crate::crate::stake::Farm::pack(&obj,ntoken.data.borrow_data());
        Ok(())
    }
    ...
    pub fn process_with_constraints(
        ...
        match instruction {
            ...
            SwapInstruction::NToken() => {
                msg!("Instruction: Ntoken Publish");
                Self::process_create_ntoken(
                    program_id,
                    destination_token_amount,
                    maximum_pool_token_amount,
                    accounts,
            ...
            SwapInstruction::Supply(LendAmount{
                amount
                                    }) => {
                msg!("Instruction: Supply {0}",amount);
                Self::process_supply(
                    program_id,
                    destination_token_amount,
                    maximum_pool_token_amount,
            ...
            SwapInstruction::Borrow(LendAmount{
                                        amount,
                                    }) => {
                msg!("Instruction: Borrow {0}",amount);
                Self::process_borrow(
                    program_id,
                    destination_token_amount,
                    maximum_pool_token_amount,
            ...
            SwapInstruction::PayBorrow(LendAmount{
                                        amount,
                                    }) => {
                msg!("Instruction: PayBorrow {0}",amount);
                Self::process_pay_borrow(
                    program_id,
                    destination_token_amount,
                    maximum_pool_token_amount,
                    accounts,
            ...
            SwapInstruction::Stake(LendAmount{
                                        amount,
                                    }) => {
                msg!("Instruction: Stake {0}",amount);
                Self::process_stake(
                    program_id,
                    destination_token_amount,
                    maximum_pool_token_amount,
            ...
            SwapInstruction::UnStake(LendAmount{
                                        amount,
                                    }) => {
                msg!("Instruction: UnStake {0}",amount);
